...
export default class AboutPage {
  ...
  public createContainerPage(): HTMLElement {
    ...
    const emptyDiv = this.createEmptyDiv();
    ...
    container.getElement().append(emptyDiv);
    container.getElement().append(footer);
    return container.getElement();
  }

  public createEmptyDiv(): HTMLElement {
    const emptyDiv = new ElementCreator({
      tagName: 'div',
      classNames: ['empty-div'],
    });
    return emptyDiv.getElement();
  }
  ...
  public createDevContainer(): HTMLElement {
    ...
    const development2 = this.createDeveloper(
      ...
      ' Developer',
      ` Профессиональный Джаваскриптизер. Родился в Бобруйске, с 2020 года живу в Гданьске. Окончил истфак БГУ и Гданьский факультет, магистр политолог. Лауреат ряда премий в сфере гражданского активизма, знаю как минимум 3 нобелевских лауреатов. Владею, русским, белорусским, польским, английским и учу традиционный китайский. Вечно в прокрастинации и в эмоциональном выгорании, это уже 18 попытка завершить курс. Вечно анализирую и занимаюсь самокопанием. Безнадежный романтик и идеалист в поисках смысла и своего места в этом безумном и насправедливом мире.`,
